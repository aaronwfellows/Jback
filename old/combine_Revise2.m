...
for iSite = sites2Proc
   ...
   %    tolerance = 0.01;
   %    tolerance2=0.01;
   %    Matwind_d100=D(5,:)./100;
   %    diff=abs(Matwind_d100-D(207,:));
   %    diff2=abs(D(5,:)-D(207,:));
   %    good=diff > tolerance & diff2 < tolerance2 & D(1,:) > 1271.04;
   %    D(207,good)=D(207,good).*100;   
    ...
    elseif iSite == 6; %James
        focus= D(1,:) > 529.3 & D(1,:) < 552.83;
        focus= focus | D(1,:) > 1271.04;
        D(207,~focus)= D(207,~focus).*100; %this is multiplied
    end
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
        ...
        elseif iSite ==6
            %go to this subdirectory
            D=Site_specific_JamesRes(HEADER, D);
        elseif iSite ==7
            %go to this subdirectory
        elseif iSite ==8
            %go to this subdirectory
